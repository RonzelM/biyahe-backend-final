...
def get_vehicle(id):
    ...
    return jsonify({"name": vehicle[0], "status": vehicle[1]})
...
def add_vehicle():
    ...
    try:
        ...
        return jsonify({"message": "Vehicle added", "plate_number": plate_number})
...
def delete_vehicle(id):
    ...
    try:
        ...
        if active:
            return jsonify({"error": "Cannot delete vehicle with active booking"}), 400
        ...
        return (
            jsonify({"message": "Vehicle archived and tracker released successfully"}),
            200,
        )
...
def approve_booking(id):
    ...
    try:
        ...
        if conflict:
            ...
            return (
                jsonify(
                    {"error": "Conflict detected", "reason": "Vehicle already booked"}
                ),
                400,
            )
...
def register_tracker():
    ...
    try:
        ...
        """,
            (tracker_id, is_online, gps_status, last_updated),
        )
        ...
        return (
            jsonify(
                {"message": "Tracker synced successfully", "tracker_id": tracker_id}
            ),
            201,
        )
